...
#if (defined(MK64F12) || defined(MK60D10) || defined(MK22F12) || defined(MKS22F25612) || defined(MK26F18) || defined(MK20D5))
 ...
 * @retval 时钟速度
 */
uint32_t UART_SetClock(uint32_t instance, uint32_t opt)
{
    uint32_t clk;
