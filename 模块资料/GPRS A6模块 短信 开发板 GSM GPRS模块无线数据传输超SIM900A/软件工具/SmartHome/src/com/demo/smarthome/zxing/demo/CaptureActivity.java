...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(final Result obj, Bitmap barcode) {
		...
		info = obj.getText();
		Toast.makeText(CaptureActivity.this, info,5000).show();
		Intent ScanIntent = new Intent();
		ScanIntent.setClass(CaptureActivity.this, ScanActivity.class);
		Bundle ScanBundle = new Bundle();
		ScanBundle.putString("info", info);
		ScanIntent.putExtras(ScanBundle);
		startActivity(ScanIntent);// 打开新界面
		finish();
		...
		if (type == 1) {
			info = obj.getText();
			Toast.makeText(CaptureActivity.this, info, 1000).show();
